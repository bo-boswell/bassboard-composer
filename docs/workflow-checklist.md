...
- [x] `[PASS D17 — fixed M5]` A section is renamed via a real text input (touch-reliable; replaced contentEditable).
...
| Device | Status |
|--------|--------|
| Desktop Chrome | baseline captured; M5 verified (headless) |
| Desktop Safari | not yet tested (M6) |
| iPad Safari landscape | touch-target CSS added M5 (44px via pointer:coarse); needs real-device confirmation at M6/pilot |
